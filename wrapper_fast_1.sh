...
#SBATCH -o /home/gilberstadt.j/Upload_from_Local/wrapper_fast_1_jobs/Sample_job.o%j
######## Job Error File: Sample_job.eJOBID ########
#SBATCH -e /home/gilberstadt.j/Upload_from_Local/wrapper_fast_1_jobs/Sample_job.e%j
######## Email
...
do
	sbatch /home/gilberstadt.j/josh_vbm_fast_1.sh $fullpath
